package com.alfresco.client.logging;
 ...
 * @href https://github.com/devcsrj/slf4j-okhttp3-logging-interceptor/
 ...
 */
public final class HttpLoggingInterceptorSLF4J implements Interceptor {
    ...
    public HttpLoggingInterceptorSLF4J() {
        this(DEFAULT_LOGGER);
    }

    public HttpLoggingInterceptorSLF4J(Logger logger) {
     ...
     */
    public HttpLoggingInterceptorSLF4J(long peekBodySize) {
     ...
     */
    public HttpLoggingInterceptorSLF4J(Logger logger, long peekBodySize) {
        if (logger == null)
