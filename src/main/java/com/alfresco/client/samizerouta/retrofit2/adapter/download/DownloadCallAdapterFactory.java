...
import com.alfresco.client.samizerouta.retrofit2.adapter.download.Download.Builder;
...
public final class DownloadCallAdapterFactory extends CallAdapter.Factory {
    ...
    public CallAdapter<?,?> get(Type returnType, Annotation[] annotations, final Retrofit retrofit) {
        ...
        return new CallAdapter<ResponseBody,Download.Builder>() {
        	@Override
            ...
            public Download.Builder adapt(Call<ResponseBody> call) {
